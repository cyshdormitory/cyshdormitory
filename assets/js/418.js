...
//418
function person4181(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person4181");
...
function person4182(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person4182");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person4183(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person4183");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person4184(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person4184");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
