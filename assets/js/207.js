...
//207
function person2071(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person2071");
...
function person2072(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person2072");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person2073(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person2073");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person2074(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person2074");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
