...
//209
function person2091(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person2091");
...
function person2092(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person2092");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person2093(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person2093");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person2094(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person2094");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
