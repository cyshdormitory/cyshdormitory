...
//117
function person1171(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person1171");
...
function person1172(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person1172");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person1173(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person1173");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person1174(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person1174");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
