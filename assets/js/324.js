...
//324
function person3241(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person3241");
...
function person3242(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person3242");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person3243(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person3243");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person3244(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person3244");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
