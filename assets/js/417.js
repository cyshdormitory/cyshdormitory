...
//417
function person4171(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person4171");
...
function person4172(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person4172");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person4173(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person4173");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person4174(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person4174");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
