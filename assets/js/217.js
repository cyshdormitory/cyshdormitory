...
//217
function person2171(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person2171");
...
function person2172(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person2172");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person2173(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person2173");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person2174(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person2174");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
