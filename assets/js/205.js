...
//205
function person2051(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person2051");
...
function person2052(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person2052");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person2053(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person2053");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person2054(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person2054");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
