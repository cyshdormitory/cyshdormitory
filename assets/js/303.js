...
//303
function person3031(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person3031");
...
function person3032(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person3032");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person3033(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person3033");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person3034(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person3034");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
