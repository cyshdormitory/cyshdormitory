...
//313
function person3131(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person3131");
...
function person3132(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person3132");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person3133(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person3133");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person3134(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person3134");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
