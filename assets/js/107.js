...
//107
function person1071(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person1071");
...
function person1072(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person1072");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person1073(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person1073");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person1074(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person1074");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
