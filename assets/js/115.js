...
//115
function person1151(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person1151");
...
function person1152(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person1152");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person1153(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person1153");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person1154(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person1154");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
