...
//119
function person1191(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person1191");
...
function person1192(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person1192");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person1193(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person1193");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person1194(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person1194");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
