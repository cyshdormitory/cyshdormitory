...
//317
function person3171(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person3171");
...
function person3172(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person3172");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person3173(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person3173");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person3174(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person3174");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
