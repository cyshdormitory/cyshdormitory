...
//307
function person3071(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person3071");
...
function person3072(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person3072");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person3073(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person3073");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person3074(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person3074");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
