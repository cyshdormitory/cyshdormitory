...
//219
function person2191(data){
    if(freq[0]%2 === 0){
        var change = document.getElementById("person2191");
...
function person2192(data){
    if(freq[1]%2 === 0){
        var change = document.getElementById("person2192");
        change.style.backgroundColor = "#6495ed";
        freq[1] += 1;
...
function person2193(data){
    if(freq[2]%2 === 0){
        var change = document.getElementById("person2193");
        change.style.backgroundColor = "#6495ed";
        freq[2] += 1;
...
function person2194(data){
    if(freq[3]%2 === 0){
        var change = document.getElementById("person2194");
        change.style.backgroundColor = "#6495ed";
        freq[3] += 1;
